...
import { seconds, secondsAllowingDisabled } from './schema/helpers.js';
import { isRuntimeConfigField, type RuntimeConfigNode } from './types.js';
...
function* walk(
  ...
  ui?: {
    multiline?: boolean;
    mapWidth?: SettingsUiHint['mapWidth'];
    kind?: SettingsUiKind;
  };
}> {
