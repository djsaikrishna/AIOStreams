...
export const builtinsSchema = {
  ...
  scrape: {
    withAllTitles: {
      ...
      description:
        'Use alternative titles when scraping built-in addons. Either a boolean or a comma-separated hostname list.',
    ...
    titleLanguages: {
      ...
      description:
        'Per-domain control over which titles to use when scraping. Format: `domain:spec,...` where spec ∈ {default, all, original, ISO-639-1}.',
